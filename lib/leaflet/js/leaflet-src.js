...
L.Map = L.Class.extend({
	...
	getMaxZoom: function () {
		return this.options.maxZoom === undefined ?
			...
			(this._layersMaxZoom === undefined ? 0 : this._layersMaxZoom) :
	...
	locate: function (/*Object*/ options) {
		...
		if (!navigator.geolocation) {
			this._handleGeolocationError({
				...
				message: 'Géolocalisation n\'est pas supporté.'
			});
			return this;
		}
	...
	_handleGeolocationError: function (error) {
		var c = error.code,
		    message = //error.message ||
		            (c === 1 ? 'permission refusée' :
		            (c === 2 ? 'position indisponible' : 'delai dépassé'));
		...
		this.fire('locationerror', {
			...
			message: 'Erreur de Géolocalisation : ' + message + '.'
		});
	},
